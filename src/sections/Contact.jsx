...
const Contact = () => {
  ...
  <div className="flex-1 c-space py-10 sm:py-20">
        {/* Header Section */}
  ...
  <div className="contact-container flex flex-col gap-8 sm:gap-12 px-4 md:px-10 mt-10 sm:mt-16">
          {/* Contact Information Cards */}
          <div className="flex flex-col gap-6 sm:gap-10 font-light text-white">
            
            {/* Email Card */}
            <div className="contact-card relative group w-full">
              ...
              <div className="relative backdrop-blur-xl bg-black/20 border border-white/10 rounded-2xl p-4 sm:p-6 md:p-8 group-hover:border-white/20 transition-all duration-300">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-semibold uppercase tracking-wider">E-mail</h2>
                </div>
                ...
                <div className="flex items-center gap-4">
                  <a 
                    ...
                    className="text-sm sm:text-lg md:text-xl lg:text-2xl tracking-wide lowercase hover:text-blue-400 transition-colors duration-300 flex-1 break-all"
                  >
            ...
            <div className="contact-card relative group w-full">
              ...
              <div className="relative backdrop-blur-xl bg-black/20 border border-white/10 rounded-2xl p-4 sm:p-6 md:p-8 group-hover:border-white/20 transition-all duration-300">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-semibold uppercase tracking-wider">Location</h2>
                </div>
                <div className="w-full h-px bg-gradient-to-r from-transparent via-white/30 to-transparent mb-4" />
                <p className="text-sm sm:text-lg md:text-xl lg:text-2xl lowercase tracking-wide">
                  Negombo, Sri Lanka
                </p>
            ...
            <div className="contact-card relative group w-full">
              ...
              <div className="relative backdrop-blur-xl bg-black/20 border border-white/10 rounded-2xl p-4 sm:p-6 md:p-8 group-hover:border-white/20 transition-all duration-300">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-semibold uppercase tracking-wider">Social Media</h2>
                </div>
                ...
                <div className="flex flex-wrap gap-2 sm:gap-4">
                  {mySocials.map((social, index) => (
                    <a
                      ...
                      className="group/social flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-xl border border-white/10 hover:border-purple-400/50 bg-white/5 hover:bg-purple-500/10 transition-all duration-300"
                    ...
                    >
                      ...
                      />
                      <span className="text-xs sm:text-sm font-medium uppercase tracking-wider opacity-70 group-hover/social:opacity-100 group-hover/social:text-purple-300 transition-all duration-300">
                        {social.name}
                      </span>
                    </a>
                  ))}
